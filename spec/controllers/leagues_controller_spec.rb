...
RSpec.describe LeaguesController, type: :controller do
  ...
  let(:valid_attributes) do
    FactoryGirl.attributes_for(:league, alley_id: FactoryGirl
                                          .create(:alley).id,
                                        administrator_id: FactoryGirl
                                          .create(:user).id)
  end
